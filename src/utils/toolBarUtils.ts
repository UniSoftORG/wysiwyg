...
export function loadToolBar(
    ...
    const applyStyles = (style: string, styleMap: Record<string, any>, editorState: EditorState, setEditorState: any) => {
        ...
        const currentStyleList = currentStyles.toArray().filter(style => style !== undefined && styleList.includes(style));
