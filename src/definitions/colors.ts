...
/**
 * Returns the color style map.
 *
 * @return {ColorStyleMap} The color style map.
 */
...
} = Object.keys(colorStyleMap).reduce(
  (acc, colorKey) => {
...
export const selectColorOptions = generateObjectOptions(
  colorStyleMap,
  MethodType.Color,
);
